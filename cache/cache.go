...
func InMemory[T any](ttl time.Duration, fn func(context.Context) (T, error)) func(context.Context, bool) (T, error) {
	data := persist.Data[T]{}

	return func(ctx context.Context, forceRefresh bool) (T, error) {
...
func OnDisk[T any](file string, ttl time.Duration, fn func(context.Context) (T, error)) func(context.Context, bool) (T, error, error) {
...
func Func[T any](store persist.Store, key string, ttl time.Duration, fn func(context.Context) (T, error)) func(context.Context, bool) (T, error, error) {
	data := persist.NewData[T](store, key)

	return func(ctx context.Context, forceRefresh bool) (T, error, error) {
...
// LogErr logs cache errors in the cached function. It can be used to simplify a functions signature if you can
